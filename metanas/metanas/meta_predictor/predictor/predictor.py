...
from utils import load_graph_config, Log, get_log, load_model, save_model, mean_confidence_interval

from loader import get_meta_train_loader, MetaTestDataset
from predictor.model import PredictorModel
...
class Predictor:
    ...
    def meta_test_dataset(self, data_name, graph):
        """TODO: should be adjusted fit pytorch-meta dataset implementation
        ...
        # TODO: Adjust the data_path here for pytorch-meta
        self.test_dataset = MetaTestDataset(
            self.data_path, data_name, self.num_sample, self.num_class)
